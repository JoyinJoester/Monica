...
他のクライアントで MDBX を接続する場合は、まず [MDBX workspace README](mdbx/README.md) と [MDBX client integration guide](mdbx/CLIENT_INTEGRATION_GUIDE.md) を読んでください。完全な形式仕様は [mdbx-doc](mdbx-doc/README.md) にあります。
